let cars = JSON.parse(localStorage.getItem("cars")) || [
    { id: 1, name: "Toyota Corolla", image: "AWD-Seatwork-1-2-FC-25/assets/img/toyota.jpg", price: "₱3,000/day", status: "Available" },
    { id: 2, name: "Honda Civic", image: "AWD-Seatwork-1-2-FC-25/assets/img/honda.jpg", price: "₱3,500/day", status: "Available" },
    { id: 3, name: "Ford Focus", image: "AWD-Seatwork-1-2-FC-25/assets/img/ford.jpg", price: "₱2,800/day", status: "Available" },
    { id: 4, name: "Tesla Model 3", image: "AWD-Seatwork-1-2-FC-25/assets/img/tesla.jpg", price: "₱6,000/day", status: "Available" },
    { id: 5, name: "Nissan Altima", image: "AWD-Seatwork-1-2-FC-25/assets/img/nissan.jpg", price: "₱3,200/day", status: "Available" },
    { id: 6, name: "BMW 3 Series", image: "AWD-Seatwork-1-2-FC-25/assets/img/bmw.jpg", price: "₱5,500/day", status: "Available" },
    { id: 7, name: "Mercedes-Benz C-Class", image: "AWD-Seatwork-1-2-FC-25/assets/img/mercedes.jpg", price: "₱6,500/day", status: "Available" },
    { id: 8, name: "Hyundai Elantra", image: "AWD-Seatwork-1-2-FC-25/assets/img/hyundai.jpg", price: "₱2,900/day", status: "Available" },
    { id: 9, name: "Chevrolet Malibu", image: "AWD-Seatwork-1-2-FC-25/assets/img/chevrolet.jpg", price: "₱3,300/day", status: "Available" },
    { id: 10, name: "Audi A4", image: "AWD-Seatwork-1-2-FC-25/assets/img/audi.jpg", price: "₱7,000/day", status: "Available" }
];
